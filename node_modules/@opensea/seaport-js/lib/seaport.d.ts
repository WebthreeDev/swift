...
export declare class Seaport {
     ...
     */
    cancelOrders(orders: OrderComponents[], accountAddress?: string, domain?: string, overrides?: PayableOverrides): TransactionMethods<ContractMethodReturnType<SeaportContract, "cancel">>;
    /**
     ...
     * @returns the set of transaction methods that can be used
     */
    bulkCancelOrders(offerer?: string, domain?: string, overrides?: PayableOverrides): TransactionMethods<ContractMethodReturnType<SeaportContract, "incrementCounter">>;
    /**
     ...
     * @returns the set of transaction methods that can be used
     */
    validate(orders: Order[], accountAddress?: string, domain?: string, overrides?: PayableOverrides): TransactionMethods<ContractMethodReturnType<SeaportContract, "validate">>;
    /**
    ...
    fulfillOrders({ fulfillOrderDetails, accountAddress, conduitKey, recipientAddress, domain, exactApproval, }: {
        ...
        domain?: string;
        exactApproval?: boolean;
    }): Promise<OrderUseCase<ExchangeAction<[boolean[], import("./typechain-types/seaport_v1_4/contracts/Seaport").ExecutionStructOutput[]]>>>;
    /**
     ...
     */
    setDomain(domain: string, accountAddress?: string, overrides?: PayableOverrides): TransactionMethods<ContractMethodReturnType<DomainRegistryContract, "setDomain">>;
    /**
