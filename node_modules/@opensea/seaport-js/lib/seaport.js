...
class Seaport {
     ...
     */
    fulfillOrder({ order, unitsToFill, offerCriteria = [], considerationCriteria = [], tips = [], extraData = "0x", accountAddress, conduitKey = this.defaultConduitKey, recipientAddress = ethers_1.ethers.constants.AddressZero, domain, exactApproval = false, overrides, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!order.signature) {
